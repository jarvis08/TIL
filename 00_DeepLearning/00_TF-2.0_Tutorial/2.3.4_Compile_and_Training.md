...
먼저 각각의 메서드들에 대해 알아본 이후, 메서드를 활용해 보도록 하겠습니다.

`train_on_batch`, `load_weight`, `save_weights`
...
optimizer 종류 https://www.tensorflow.org/api_docs/python/tf/keras/optimizers
...
loss 종류 https://www.tensorflow.org/api_docs/python/tf/losses

`metrics`는 학습 과정을 모니터링 하기 위해 사용되며, accuracy와 같은 척도를 사용합니다.

metrics 종류 https://www.tensorflow.org/api_docs/python/tf/metrics
...
`fit` 메서드에도 세 개의 중요한 매개변수가 있습니다. `epochs`, `batch_size`, `validation_data`
